...
/*Задание
        ...
        1. Реализовать уровень доступа к данным, который взаимодействует с базой PostgreSQL. Реализовать методы добавления, удаления, получения и обновления пользователя в базе. Реализовать логику регистрации и логина пользователя с взаимодействием с базой данных.
